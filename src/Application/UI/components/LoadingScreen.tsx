        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 07/11/2000</p>
                            <p>BIOS (C)2000 Jean Pierre Sfeir Inc.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>S13 2000-2024 Special UC131S</p>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Jean Pierre Sfeir Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Jean Pierre Sfeir Portfolio Showcase 2024</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
            ...
            {firefoxError && (
                ...
                >
                    <div style={styles.startPopup}>
                        ...
                        <div style={styles.spacer} />
                        <p>
                            Due to a bug in firefox, this website is temporarily inaccessible for
